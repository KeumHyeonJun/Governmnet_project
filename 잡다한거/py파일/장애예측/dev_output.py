...
def main(opt):
	...
	dev_equipment_analysis.columns=['class1','fac_class','dong','floor','fac_cd','fac_nm','cnt_broken','last_broken','prob_broken_07','prob_broken_30','reg_time']
	dev_time_analysis.columns =[
		'dev_group',
		'median',
		'mean',
		'max',
	...
	dev_equipment_analysis.columns = [
		'reg_time',
		'fac_class',
		'mat_nm',
		'mat_type',
